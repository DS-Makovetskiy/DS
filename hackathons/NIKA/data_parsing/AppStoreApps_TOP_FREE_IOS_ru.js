...
const fetchData = async () => {
  ...
  const saveDataToFile = async (apps, index) => {
    const filePath = `../data/AppStoreApps_TOP_FREE_IOS_ru${String(index).padStart(3, '0')}.json`;
...
// const fetchData = async () => {
//   const filePath = '../data/AppStoreApps_TOP_FREE_IOS_ru.json';
...
//   fs.writeFileSync('AppStoreApps_TOP_FREE_IOS_ru.json', JSON.stringify(allApps, null, 2));
// };
