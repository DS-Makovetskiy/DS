    ...
    for (let page = 0; page < 50; page++) {  // 50 страниц по 200 элементов = 10000 приложений
      try {
        const apps = await store.list({
          category: category,
          collection: store.collection.NEW_IOS,
...
// const fetchData = async () => {
//   const filePath = '../data/AppStoreApps_NEW_IOS_ru.json';
...
//   fs.writeFileSync('AppStoreApps_NEW_IOS_ru.json', JSON.stringify(allApps, null, 2));
// };
